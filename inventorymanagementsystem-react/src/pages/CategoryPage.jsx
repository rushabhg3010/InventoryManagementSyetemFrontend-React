...
const CategoryPage = () => {
  ...
  useEffect(() => {
    const getCategories = async () => {
      try {
        ...
        showMessage(
          error.response?.data?.message || "Error Setting up Category: " + error
        );
      }
    };
    getCategories();
  ...
  const addCategory = async () => {
    ...
    try {
      ...
      showMessage(
        error.response?.data?.message || "Error while adding Category: " + error
      );
    }
  };
  ...
  const editCategory = async () => {
    try {
      ...
      showMessage(
        error.response?.data?.message || "Error while editing Category: " + error
      );
    }
  };
